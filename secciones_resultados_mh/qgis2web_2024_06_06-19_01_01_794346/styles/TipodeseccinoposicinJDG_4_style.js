...
var style_TipodeseccinoposicinJDG_4 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    var value = feature.get("oposi_int");
    var labelText = "";
    size = 0;
    ...
    if (value >= 44.740000 && value <= 51.520000) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 51.520000 && value <= 59.100000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 59.100000 && value <= 74.440000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 74.440000 && value <= 86.320000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 86.320000 && value <= 94.450000) {
            style = [ new ol.style.Style({
